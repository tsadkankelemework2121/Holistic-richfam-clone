...
import { fetchEventsByCategory } from "../../api/api"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-12">
            <p className="text-red-600 mb-4">
              Error loading {activeTab} events: {error instanceof Error ? error.message : "Failed to fetch events"}
            </p>
        ...
        {events.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-500 mt-2">
              ...
              {activeTab === "upcoming" ? "upcoming-event" : activeTab === "workshops" ? "workshop" : "special-program"}
            </p>
          </div>
        )}
