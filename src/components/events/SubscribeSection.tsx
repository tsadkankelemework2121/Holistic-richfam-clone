...
const SubscribeSection = () => {
  ...
  return (
    <div className="bg-white rounded-2xl p-8 shadow-lg sticky top-8 h-[600px] flex flex-col"> {/* Changed height to fixed 600px and added flex-col */}
      <div className="flex-grow"> {/* Wrapped content in flex-grow container */}
        ...
        <p className="text-gray-700 mb-8 leading-relaxed">
          ...
          growth. You'll also receive updates on our upcoming events and workshops.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            } ${isLoading || !email.trim() ? "opacity-70 cursor-not-allowed" : "hover:scale-[1.02] active:scale-[0.98]"}`}
          >
            {isLoading ? (
              <>
