...
const MembershipsPackages = () => {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
              Become a valued member of our community and choose a plan that best suits your family's needs. Each
              package is designed to offer <span className="font-bold">flexibility</span>,{" "}
            ...
            {packages.map((pkg, index) => (
              <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <div className="text-center">
                  <button
                    onClick={() => handleRegisterClick(pkg.packageValue)}
                    className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold px-8 py-3 rounded-full transition-colors shadow-md hover:shadow-lg"
                  >
                    {pkg.buttonText}
                  </button>
                </div>
      ...
      {/* Registration Modal */}
      <RegistrationModal isOpen={isModalOpen} onClose={handleCloseModal} selectedPackage={selectedPackage} />
    </>
  )
}
