...
function ParentingTipsSection() {
  ...
  // Debug logs
  console.log("Parenting Tips - Full data:", data)
  console.log("Parenting Tips - isLoading:", isLoading)
  console.log("Parenting Tips - error:", error)

  if (isLoading) {
    return (
      <section className="py-16 px-6 bg-[#F6F6F6]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-[37px] font-bold text-[#1E3A8A] text-left mb-8">Parenting Tips</h2>
    ...
    return (
      <section className="py-16 px-6 bg-[#F6F6F6]">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="text-center text-red-500">Error loading parenting tips: {error.message}</div>
          </div>
        </div>
      </section>
    )
  ...
  // More debug logs
  console.log("Parenting Tips - sortedBlogs:", sortedBlogs)
  console.log("Parenting Tips - currentBlogs:", currentBlogs)
  console.log("Parenting Tips - currentPage:", currentPage)
