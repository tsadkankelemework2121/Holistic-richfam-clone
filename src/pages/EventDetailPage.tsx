          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-3xl shadow-lg overflow-hidden">
                  ...
                  {event.image ? (
                    <img
                      ...
                      onError={(e) => {
                        ...
                        e.currentTarget.src = "/images/event-hero.png"
                      }}
                    />
                  ) : (
                    <img src="/images/event-hero.png" alt="RICHFAM Event" className="w-full h-full object-cover" />
                  )}
                </div>
                ...
                <div className="p-8">
                  {/* Event Title */}
                  <h1 className="text-3xl font-bold text-blue-900 mb-6">{event.title}</h1>
                  ...
                  {/* Event Description - Only Fetched Data */}
                  <div className="prose prose-lg max-w-none">
                    {event.intro && (
                      <div className="mb-8">
                        <p className="text-gray-700 leading-relaxed text-lg whitespace-pre-wrap">{event.intro}</p>
                      </div>
                    )}
                    ...
                    {event.requirements && (
                      <div className="mb-8">
                        ...
                        <p className="text-gray-700 leading-relaxed whitespace-pre-wrap">{event.requirements}</p>
                      </div>
                    )}
                  ...
                  <div className="pt-8 border-t border-gray-200">
                    <button
                      ...
                      className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold py-4 px-12 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                    >
                      Book Now
                    </button>
                  </div>
            ...
            {/* Right Column - Fixed Subscribe Section */}
